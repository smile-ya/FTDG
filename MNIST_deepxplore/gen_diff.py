...
from MNIST_deepxplore.model.Model1 import Model1
from MNIST_deepxplore.model.Model2 import Model2
from MNIST_deepxplore.model.Model3 import Model3
from MNIST_deepxplore.model.Model4 import Model4
...
parser.add_argument('--step', help="step size of gradient descent", type=float,default=0.02)
parser.add_argument('--grad_iterations', help="number of iterations of gradient descent", type=int, default=60)

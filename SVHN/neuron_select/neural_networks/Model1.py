...
import os
print("gggg"+str(os.path.dirname(__file__)))
print(os.getcwd())

print(os.path.join(os.path.dirname(__file__), 'Model1.h5'))
...
def Model1(input_tensor=None, train=False):
    ...
    # block2
    x = Convolution2D(12, kernel_size, activation='relu', padding='valid', name='block2_conv1')(x)
    ...
    if train:
        ...
        # save model
        model.save_weights(os.path.join(os.path.dirname(__file__), 'Model1.h5'))
